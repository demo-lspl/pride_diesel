...
<div class="">
	...
	<?php } ?>
			...
			<div class="card-body">
                    <form class="search form-inline" action="<?php echo base_url().'user/moneyCodeInvoice'; ?>" method="get" autocomplete="off">
                ...
                <table id="" class="table table-bordered table-striped table-hover">
                  ...
                  <tr>
                    ...
                    <td align="center">
					<a href="<?php echo base_url('user/moneyCodeTrans/').$invoicePendingRows->id ?>" class="btn btn-primary" ><i class=" fa fa-eye"></i></a>
					</td>
                  </tr>
				  <?php endforeach; }else{ ?>
				<tr>
