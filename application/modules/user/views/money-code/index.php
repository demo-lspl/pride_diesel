...
<div class="">
	...
	<?php } ?>
			...
			<?php //print_r($allUserData) ?>
                    <form class="search form-inline" action="<?php echo base_url().'user/money_code_issued'; ?>" method="get" autocomplete="off">
                ...
                <table id="" class="table table-bordered table-striped table-hover">
                  ...
                  <tr>
                    ...
                    <td><?= $getCardsRows->company_name?></td>
                    <td><?= $getCardsRows->company_email?></td>
                    <td align="center">
					<a href="<?php echo base_url('user/money_code_issue/').$getCardsRows->id ?>" class="btn btn-default" ><i class=" fa fa-pen"></i></a> <a href="<?php echo base_url('user/delete_money_code/').$getCardsRows->id ?>" onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-danger button-delete" ><i class="fa fa-trash"></i></a>
					</td>
                  </tr>
				  <?php endforeach; ?>	
                  </tbody>
