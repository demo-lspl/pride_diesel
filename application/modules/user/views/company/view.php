		...
		<div class="card-body">
			<div class="row justify-content-center">
				<div class="col-sm-12">
					...
					<?php
					$getPriceDate = $this->db->select('date, date_created')->where('id', 1)->get('retail_pricing')->row();	
					...
					?>
						<table class="table table-bordered">
							...
							$retailPriceDecode = json_decode($priceListEdited->$usaPricing);
