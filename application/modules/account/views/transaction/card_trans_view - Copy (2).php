					...
					<div class="panel panel-default">
						...
						<div class="panel-body goods_descr_wrapper">			
							...
							<div class="col-md-12 input_descr_wrap label-box mobile-view2">
								...
								<?php if(!empty($cardDetails)){ foreach($cardDetails as $card){?>
								<?php if(!empty($driverDetails->driver_id)){$dResult = $this->db->where('id', $driverDetails->driver_id)->get('drivers')->row();}else{$dResult = null;}?>
								<?php 
								  $decCategory = json_decode($card->category);
								  $decAmount = json_decode($card->amount);
								...
								?>
									...
									<div class="col-md-2 col-sm-12 col-xs-12 form-group">															
										<label class="col-md-12 col-sm-12 col-xs-12" for="matrialname">Product Name</label>
										<div class="field-val-div"><?= implode(', ', $decCategory)?></div>

									</div>
									<div class="col-md-2 col-sm-12 col-xs-12 form-group">	
									   <label class="col-md-12 col-sm-12 col-xs-12" for="descriptions">Quantity</label>														
										<div class="field-val-div"><?= implode(', ', $decQuantity)?></div>
											
									</div>														
									<div class="col-md-2 col-sm-12 col-xs-12 form-group">	 
									  <label class="col-md-12 col-sm-12 col-xs-12" for="hsn/sac">Price </label>														
										<div class="field-val-div"><?= implode(', ', $decUnit_price)?></div>														
									</div>														
									...
									<div class="col-md-1 col-sm-12 col-xs-12 form-group">
                                        <label class="col-md-12 col-sm-12 col-xs-12" for="rate">Amount</label>									
										<div class="field-val-div"><?= implode(', ', $decAmount)?></div>
									</div>														
									<div class="col-md-2 col-sm-12 col-xs-12 form-group">
