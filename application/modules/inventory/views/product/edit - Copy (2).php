				...
				<form role="form" method="post" action="<?php echo base_url('inventory/edit_product/').$this->uri->segment(3) ?>">
					<div class="">
					  ...
					  <div class="form-group">
						...
						<?php isset($product->tax)?$taxes = json_decode($product->tax):''; //print_r($taxes);?>
						<label for="InputShower" class="checkbox-inline"><input type="checkbox" name="taxes[]" class="" id="InputShower" <?php if(!empty($taxes) && in_array('fet', $taxes) == true):echo 'checked';endif;?> value="fet"> FET</label>
						<label for="InputDinner" class="checkbox-inline"><input type="checkbox" name="taxes[]" class="" id="InputDinner" <?php if(!empty($taxes) && in_array('pft', $taxes) == true):echo 'checked';endif;?> value="pft"> PFT</label>
						<label for="InputLunch" class="checkbox-inline"><input type="checkbox" name="taxes[]" class="" id="InputLunch" <?php if(!empty($taxes) && in_array('pct', $taxes) == true):echo 'checked';endif;?> value="pct"> PCT</label>
